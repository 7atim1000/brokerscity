...
const EditOwner = ({ onClose, ownerData, onSuccess }) => {
    ...
    useEffect(() => {
        ...
        setFormData({
            ...
            balance_opening:
                ownerData.balance_opening !== null &&
                ownerData.balance_opening !== undefined
                    ? ownerData.balance_opening
                    : "",
        });
    ...
    const handleSubmit = async (e) => {
        ...
        if (!ownerData?.id) {
            toast.error("بيانات المالك غير موجودة");
            return;
        }
        ...
        try {
            ...
            console.log("Updating owner:", requestData);

            const response = await fetch(
                `${BASE}/api/owners/${ownerData.id}/update/`,
                {
                    method: "PUT",
                    headers: {
            ...
            if (!response.ok) {
                let errorMessage = "حدث خطأ أثناء تحديث المالك";
            ...
            toast.error(
                `❌ ${error.message || "حدث خطأ أثناء تحديث المالك"}`
            );
        } finally {
            setLoading(false);
        }
